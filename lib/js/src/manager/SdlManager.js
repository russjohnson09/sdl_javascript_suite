...
class SdlManager extends EventEmitter {
    ...
    async sendRPC(rpcMessage, timeout = this.rpcTimeout) {
        ...
        console.log(`getCorrelationID`,rpcMessage);
    ...
    _sendDataToCore(data) {
        console.log(`_sendDataToCore`,data);
    ...
    async _handleOnMessageAssembled(sdlPacket) {
        ...
        console.log(`handleOnMessageAssembled`,sdlPacket,{serviceType,frameType,controlFrameInfo, messageId})
        ...
        if (frameType === SdlPacket.FRAME_TYPE_CONTROL) {
            if (controlFrameInfo === SdlPacket.FRAME_INFO_START_SERVICE_ACK) {
                ...
                console.log(`FRAME_INFO_HEART_BEAT`,sdlPacket);
            ...
            //can also happen if no hearbeat response if given.
                ...
                //WARN  [21:21:54,843][ConnectionHandler] Wrong hash_id for session 0
                console.error(`FRAME_INFO_END_SERVICE_NAK`)
                console.error(`FRAME_INFO_END_SERVICE_NAK`,sdlPacket);
                return;
            }
            ...
            console.error(`unhandled controlFrameInfo`, controlFrameInfo);
    ...
    async _handleStartServiceAcknowledgment(packet) {
        ...
        console.log(`_handleStartServiceAcknowledgment`,{sessionId,version});
